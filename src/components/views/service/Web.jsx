      ...
      {loading ? (
        ...
        <>
          ...
          <section>
            <div>
              <p>
                En el mundo digital, tu página web es la primera impresión que
                los clientes tienen de tu negocio. Diseñamos y desarrollamos
                páginas web que no solo reflejan la calidad de tus servicios,
                sino que también te ayudan a atraer y fidelizar clientes.
              </p>
            </div>
              ...
              <Row className="mt-5 justify-content-center">
                <Col md={6} className="d-flex justify-content-center">
                  <ul>
                    ...
                    <li>
                      <strong>Optimización móvil:</strong> Diseños adaptados
              ...
              <Row className="mt-5 justify-content-center">
                ...
                <Col md={6} className="d-flex justify-content-center">
                  <ul>
                    ...
                    <li>
                      <strong>Desarrollo ágil:</strong> Construimos tu página
                      web con tecnologías modernas.
                    </li>
                    <li>
                      <strong>Lanzamiento y soporte:</strong> Te acompañamos en
                      el lanzamiento y ofrecemos soporte técnico.
                    </li>
                  </ul>
                </Col>
              </Row>
            ...
            <div className="mt-5">
              <p>
                Transforma tu negocio con una página web diseñada para destacar.
                En el mundo digital, tu presencia online marca la diferencia.
